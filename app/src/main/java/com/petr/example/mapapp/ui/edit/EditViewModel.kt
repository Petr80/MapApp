...
class EditViewModel @AssistedInject constructor(
    ...
    fun saveItem(itemId1: Long, edit_1: String, edit_2: String, edit_3: String, roll_1: String, roll_2: String, imageUrl1: String) {

        val itemToSave = Item(itemId1, edit_1, edit_2, edit_3, roll_1, roll_2, imageUrl1)
